    ...
    public function balance()
    {
        try {
            ...
            if ($response->successful()) {
                ...
                if ($balance !== null) {
                    return view('admin.topupedia.ceksaldobj', ['saldo' => $balance]);
                } else {
                    $error = $response->json();
            ...
            return view('admin.topupedia.ceksaldobj', ['error' => $e->getMessage()]);
        }
    }
    ...
    public function getProduct()
{
    try {
        ...
        if ($response->successful()) {
            $data = $response->json();
            return view('admin.topupedia.products', ['products' => $data]);
        } else {
            $error = $response->json();
            return view('admin.topupedia.products', ['error' => $error]);
        }
    } catch (\Exception $e) {
        return view('admin.topupedia.products', ['error' => $e->getMessage()]);
    }
}
