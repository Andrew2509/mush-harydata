...
@include('components.user.seo', ['title' => 'Kalkulator Zodiac'])
    ...
    <div class="max-w-3xl mx-auto px-6 relative z-10">
        <div class="text-center mb-16">
            ...
            <p class="text-slate-400 text-base leading-relaxed max-w-md mx-auto">
                Gunakan alat ini untuk mengetahui total maksimal diamond yang dibutuhkan untuk mendapatkan skin Zodiac impian Anda di Mobile Legends.
            </p>
        </div>

        <div class="glass p-6 md:p-10 rounded-[2rem] shadow-2xl relative overflow-hidden group">
            <div class="absolute top-0 right-0 p-4 opacity-10">
                <span class="material-icons-round text-6xl">auto_fix_high</span>
            </div>
            
            <div class="space-y-12">
                <div class="space-y-6">
                    <div class="flex justify-between items-center">
                        <label class="text-xs font-bold uppercase tracking-widest text-primary">Geser sesuai Titik Zodiac Anda</label>
                        <span class="text-xl font-black text-accent bg-accent/10 px-3 py-1 rounded-lg" id="sliderValueDisplay">50</span>
                    </div>
                    <input class="w-full" id="zodiacRange" max="99" min="0" type="range" value="50"/>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white/5 dark:bg-black/20 p-5 rounded-xl border border-white/5 flex flex-col items-center justify-center text-center relative overflow-hidden">
                        ...
                        <div class="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                            <span class="text-primary" id="requiredDiamonds">850</span>
                ...
                <div class="pt-4">
                    <a href="{{ url('/id/mobile-legends') }}" class="w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-extrabold py-5 rounded-2xl text-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(14,165,233,0.3)] flex items-center justify-center gap-3 group relative overflow-hidden">
...
<script>
    const range = document.getElementById('zodiacRange');
    ...
    function updateValues() {
        ...
        // MLBB Zodiac Calculation Logic
        let diamondRequired = 0;
        if (val < 90) {
            diamondRequired = Math.ceil((2000 - val * 20) * 850 / 1000);
        } else {
            diamondRequired = Math.ceil((2000 - val * 20));
        }
