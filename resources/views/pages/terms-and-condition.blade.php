...
<div class="container pt-4 md:mx-auto md:pt-16">
    <div class="rounded-md bg-secondary-900 p-8 shadow-lg">
        <div class="flex flex-col gap-4">
            <div class="text-xl"><h1>Terms and Conditions</h1></div>
            <div class="flex flex-col gap-1">
                <p class="text-xs">Welcome to Yuramarkets.com!</p>
                <p class="text-xs">These terms and conditions outline the rules and regulations for the use of Yuramarkets.com's Website, located at <a class="text-primary-500" href="https://www.Yuramarkets.com">https://www.Yuramarkets.com.</a></p>
                <p class="text-xs">By accessing this website we assume you accept these terms and conditions. Do not continue to use Yuramarkets.com if you do not agree to take all of the terms and conditions stated on this page.</p>
                <p class="text-xs">
                ...
                <p class="text-xs">We employ the use of cookies. By accessing Yuramarkets.com, you agreed to use cookies in agreement with the Yuramarkets.com's Privacy Policy.</p>
                <p class="text-xs">
                ...
                <p class="text-xs">
                    Unless otherwise stated, Yuramarkets.com and/or its licensors own the intellectual property rights for all material on Yuramarkets.com. All intellectual property rights are reserved. You may access this from Yuramarkets.com for your own
                    personal use subjected to restrictions set in these terms and conditions.
                </p>
                <p class="text-xs">You must not:</p>
                <ul class="ml-4 list-disc">
                    <li class="text-xs">Republish material from Yuramarkets.com</li>
                    <li class="text-xs">Sell, rent or sub-license material from Yuramarkets.com</li>
                    <li class="text-xs">Reproduce, duplicate or copy material from Yuramarkets.com</li>
                    <li class="text-xs">Redistribute content from Yuramarkets.com</li>
                </ul>
                <p class="text-xs">
                ...
                <p class="text-xs">
                    Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website.Yuramarkets.com does not filter, edit, publish or review Comments prior to their presence on
                    the website. Comments do not reflect the views and opinions of Yuramarkets.com,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
                    applicable laws, Yuramarkets.com shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
                    website.
                </p>
                <p class="text-xs">Yuramarkets.com reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
                ...
                <p class="text-xs">You hereby grant Yuramarkets.com a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
                ...
                <p class="text-xs">
                    ...
                    records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Yuramarkets.com; and (d) the link is in the context of general resource information.
                </p>
                <p class="text-xs">
                ...
                <p class="text-xs">
                    If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Yuramarkets.com. Please include your name, your organization name,
                ...
                <p class="text-xs">No use of Yuramarkets.com's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                ...
                <p class="text-xs">Please read <a href="https://www.Yuramarkets.com/privacy-policy">Privacy Policy</a></p>
