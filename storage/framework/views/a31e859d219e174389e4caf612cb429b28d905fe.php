...
<head>
    ...
    <!-- SEO Meta Tags -->
    <?php echo $__env->make('components.user.seo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/assets/css/simple.css')); ?>">
...
<?php /**PATH E:\muslihinnnn (1)\harydata\resources\views/layouts/user.blade.php ENDPATH**/ ?>