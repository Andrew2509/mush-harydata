...
<head>
    ...
    <title>Admin Login — <?php echo e(config('app.name', 'Dashboard')); ?></title>
...
<body class="min-h-screen flex flex-col md:flex-row font-body">
    ...
    <div class="w-full md:w-5/12 relative bg-purple-900 overflow-hidden min-h-[240px] md:min-h-screen">
        <video
            ...
            src="<?php echo e(asset('video/617837642701099810.mp4')); ?>"
        ></video>
    ...
    <div class="w-full md:w-7/12 min-h-screen flex items-center justify-center bg-modal-dark p-8 md:p-16">
        <div class="w-full max-w-md">
            ...
            <form method="POST" action="<?php echo e(route('post.adminlogin')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="text-center mt-8">
                    <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center gap-2 text-xs text-gray-500 hover:text-primary transition-colors duration-300">
...
<?php /**PATH E:\muslihinnnn (1)\harydata\resources\views/admin/adminlogin.blade.php ENDPATH**/ ?>