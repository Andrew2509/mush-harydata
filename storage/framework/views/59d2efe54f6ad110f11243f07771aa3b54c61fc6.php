...
<head>
<meta charset="utf-8" /><title><?php echo e(!$config ? '' : $config->judul_web); ?> — Admin Panel</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0"> <link rel="manifest" href="<?php echo e(asset('assets/site.webmanifest')); ?>"><meta name="theme-color" content="#0a0e17"><meta name="csrf-token" content="<?php echo e(csrf_token()); ?>"><meta content="<?php echo e(!$config ? '' : $config->deskripsi_web); ?>" name="description" /><meta content="SURS" name="author" /><meta http-equiv="X-UA-Compatible" content="IE=edge" /><meta name="description" content="Dashboard admin " /><link rel="icon" type="image/x-icon" href="<?php echo e(ENV('APP_IMAGE')); ?>" />
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo" style="padding: 1.2rem 1.5rem;">
            <a href="<?php echo e(route('dashboard')); ?>" class="app-brand-link" style="display:flex;align-items:center;gap:10px;text-decoration:none;">
                <img src="<?php echo e(ENV('APP_IMAGE')); ?>" alt="Logo" style="width:36px;height:36px;border-radius:8px;border:1px solid rgba(0,240,255,0.2);box-shadow:0 0 10px rgba(0,240,255,0.15);">
         ...
         <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?php echo e(request()->is('pesanan', 'data/joki', 'data/giftskin') ? 'active' : ''); ?>">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon fas fa-shopping-cart"></i>
                    <div>Pesanan</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item <?php echo e(request()->is('pesanan') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('pesanan')); ?>" class="menu-link">
                            <div>Semua Pesanan</div>
                        </a>
                    </li>
                    <li class="menu-item <?php echo e(request()->is('data/joki') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/data/joki')); ?>" class="menu-link">
                            <div>Pesanan Joki & Vilog</div>
                        </a>
                    </li>
                    <li class="menu-item <?php echo e(request()->is('data/giftskin') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/data/giftskin')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('latency') ? 'active' : ''); ?>">
                <a href="<?php echo e(url('/latency')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('admin/sus*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.sus.index')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('member') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('member')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->routeIs('userdeposit', 'user-deposit') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('userdeposit')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('kategori') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('kategori')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->routeIs('layanan', 'paket.index') ? 'active' : ''); ?>">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon fas fa-box"></i>
                    <div>Produk</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item <?php echo e(request()->routeIs('layanan') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('layanan')); ?>" class="menu-link">
                            <div>Layanan</div>
                        </a>
                    </li>
                    <li class="menu-item <?php echo e(request()->routeIs('paket.index') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('paket.index')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('voucher') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('voucher')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('berita') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('berita')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('method') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('method')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('rating-customer') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('rating-customer')); ?>" class="menu-link">
            ...
            <li class="menu-item <?php echo e(request()->is('digiflazz/*', 'bangjeff/*', 'topupedia/*') ? 'active' : ''); ?>">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon fas fa-bolt"></i>
                    <div>Provider</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item <?php echo e(request()->is('digiflazz/*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('digiflazz.prices')); ?>" class="menu-link">
                            <div>Digiflazz</div>
                        </a>
                    </li>
                    <li class="menu-item <?php echo e(request()->is('bangjeff/*') ? 'active' : ''); ?>">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <div>Bangjeff</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item <?php echo e(request()->is('bangjeff/balance') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('bangjeff.balance')); ?>" class="menu-link">
                                    <div>Cek Saldo</div>
                                </a>
                            </li>
                            <li class="menu-item <?php echo e(request()->is('bangjeff/product') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('bangjeff.product')); ?>" class="menu-link">
                                    <div>Produk</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item <?php echo e(request()->is('topupedia/*') ? 'active' : ''); ?>">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <div>Topupedia</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item <?php echo e(request()->is('topupedia/balance') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('topupedia.balance')); ?>" class="menu-link">
                                    <div>Cek Saldo</div>
                                </a>
                            </li>
                            <li class="menu-item <?php echo e(request()->is('topupedia/product') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('topupedia.product')); ?>" class="menu-link">
                                    <div>Produk</div>
                                </a>
                            </li>
                        </ul>
            ...
            <li class="menu-item <?php echo e(request()->is('setting/web') ? 'active' : ''); ?>">
                <a href="<?php echo e(url('/setting/web')); ?>" class="menu-link">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item me-2">
                    <a href="<?php echo e(url('/')); ?>" target="_blank" class="btn-view-site">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <img src="<?php echo e(ENV('APP_IMAGE')); ?>"  alt="" class="w-px-30 h-auto " />
                </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="<?php echo e(ENV('APP_IMAGE')); ?>" alt class="w-px-40 h-auto rounded-circle" />
                            </div>
                          </div>
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?php echo e(ENV('APP_NAME')); ?></span>
                    ...
                    <li>
                      <a class="dropdown-item" href="<?php echo e(url('/setting/web')); ?>">
            ...
            <footer class="content-footer footer bg-footer-theme mt-5">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0" style="display:flex;align-items:center;gap:6px;">
                  ...
                  <a href="<?php echo e(env('APP_URL')); ?>" target="_blank" class="footer-link fw-bolder" style="font-family:'Orbitron',sans-serif;font-size:0.75rem;letter-spacing:1px;"><?php echo e(env('APP_NAME')); ?></a>
...
<?php /**PATH E:\muslihinnnn (1)\harydata\resources\views/layouts/admin.blade.php ENDPATH**/ ?>