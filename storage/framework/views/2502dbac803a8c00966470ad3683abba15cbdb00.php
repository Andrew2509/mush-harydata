...
<div class="container-xxl flex-grow-1 container-p-y">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.5rem;flex-wrap:wrap;gap:10px;">
        ...
        <a href="<?php echo e(route('admin.sus.index')); ?>" class="btn btn-secondary btn-sm">
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($q->order); ?></td>
                                    <td>
                                        <form action="<?php echo e(route('admin.sus.question.update', $q->id)); ?>" method="POST" class="d-flex gap-2">
                                            <?php echo csrf_field(); ?>
                                            <input type="text" name="question_text" class="form-control form-control-sm" value="<?php echo e($q->question_text); ?>">
                                            <input type="number" name="order" class="form-control form-control-sm" value="<?php echo e($q->order); ?>" style="width: 60px;">
                                            <button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-save"></i></button>
                                        </form>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('admin.sus.question.delete', $q->id)); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus pertanyaan ini?')">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.sus.question.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="order" class="form-control" required value="<?php echo e($questions->max('order') + 1); ?>">
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\muslihinnnn (1)\harydata\resources\views/admin/sus/manage.blade.php ENDPATH**/ ?>