                    ...
                    <table class="table" id="pesanan-table">
                        ...
                        <tbody>
                            ...
                            <tr class="table-<?php echo e($label_pesanan); ?>">
                                <th scope="row"><a href="<?php echo e(ENV('APP_URL')); ?>/id/invoices/<?php echo e($data_pesanan->order_id); ?>"><?php echo e($data_pesanan->order_id); ?></a><br><small style="color:#5a6380;"><?php echo e($data_pesanan->created_at); ?></small></th>
                                <td>Rp. <?php echo e(number_format($data_pesanan->harga, 0, '.', ',')); ?><br><small><?php echo e($data_pesanan->status_pembayaran); ?></small><br><small><?php echo e($data_pesanan->metode); ?></small></td>
                                <td><?php echo e($data_pesanan->layanan); ?></td>
                                <td><?php echo e($data_pesanan->nickname ?? ''); ?> <?php echo e($data_pesanan->nickname_joki ?? ''); ?><br><?php echo e($data_pesanan->user_id); ?>  <?php echo e($data_pesanan->zone != null ? "(".$data_pesanan->zone.")" : ''); ?> </td>
                                <td>
                                    <div class="btn-group-vertical">
                                         <button id="btnGroupDrop1" type="button" class="btn btn-sm btn-<?php echo e($label_pesanan); ?> dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                        <?php echo e($status_display); ?> <i class="mdi mdi-chevron-down"></i>
                                    </button>
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <li><a class="dropdown-item process-link" href="/process-order/<?php echo e($data_pesanan->order_id); ?>" data-status="<?php echo e($status); ?>">Process</a></li>
                                            <li><a class="dropdown-item status-link" href="/order-status/<?php echo e($data_pesanan->order_id); ?>/Sukses" data-current-status="<?php echo e($status); ?>" data-target-status="Sukses">Success</a></li>
                                            <li><a class="dropdown-item status-link" href="/order-status/<?php echo e($data_pesanan->order_id); ?>/Batal" data-current-status="<?php echo e($status); ?>" data-target-status="Batal">Cancelled</a></li>
                                            <li><a class="dropdown-item status-link" href="/order-status/<?php echo e($data_pesanan->order_id); ?>/Pending" data-current-status="<?php echo e($status); ?>" data-target-status="Pending">Pending</a></li>
                                        </ul>
                                    </div>
                                </td>
                                <td><small><?php echo e($status_info); ?></small></td>
                                <td><small><?php echo e($data_pesanan->provider_order_id ?? '-'); ?></small></td>
                                <td><small><?php echo e($data_pesanan->log); ?></small></td>
                                <td><small><?php echo e($data_pesanan->ip_address); ?></small></td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\muslihinnnn (1)\harydata\resources\views/admin/transaction.blade.php ENDPATH**/ ?>