...
<?php $__env->startSection('custom_style'); ?>
    <link href="<?php echo e(asset('assets/css/tailwind-built.css')); ?>" rel="stylesheet">
    ...
    <main class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-10 space-y-10 md:space-y-14">
        ...
        <div id="hero-loop-container" class="relative group mt-4">
                ...
                <div class="absolute inset-0 flex items-center px-8 md:px-16 lg:px-24 pointer-events-none z-10">
                    <div class="max-w-xl flex flex-col items-center text-center space-y-2 md:space-y-4">
                        <div class="flex flex-col items-center">
                            <img src="<?php echo e(asset('assets/logo/mobile-legends-seeklogo.png')); ?>" alt="ML Logo"
            ...
            <div id="banner-wrapper" class="hidden opacity-0 transition-all duration-1000">
                    ...
                    <?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="snap-start min-w-full carousel-item relative aspect-[21/9] lg:aspect-[31/10] xl:aspect-[3/1] overflow-hidden group/slide"
                            ...
                            <a href="<?php echo e($data->url); ?>">
                                ...
                                ?>
                                <?php if($is_video): ?>
                                    <video src="<?php echo e(asset($data->path)); ?>" class="w-full h-full object-cover transition-transform duration-1000 group-hover/slide:scale-105" autoplay muted loop playsinline></video>
                                <?php else: ?>
                                    <img alt="Banner <?php echo e($key + 1); ?>"
                                        class="w-full h-full object-cover transition-transform duration-1000 group-hover/slide:scale-105"
                                        src="<?php echo e(asset($data->path)); ?>" />
                                <?php endif; ?>
                                <div
                ...
                <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2">
                    <?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="w-8 h-1 rounded-full <?php echo e($key == 0 ? 'bg-secondary' : 'bg-white/20'); ?>"></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <section>
            ...
            <div id="populer-scroll-mobile" class="grid grid-cols-2 gap-2 md:hidden md:pb-6 relative w-full h-full">
                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($category->tipe == 'populer'): ?>
                        <a href="<?php echo e(url('/id/' . $category->kode)); ?>"
                            ...
                            <div
                                ...
                                <img alt="<?php echo e($category->nama); ?>"
                                    src="<?php echo e(str_contains($category->thumbnail, 'http') ? $category->thumbnail : (file_exists(public_path($category->thumbnail)) ? asset($category->thumbnail) : asset('assets/thumbnail/hok.webp'))); ?>"
                                    onerror="this.src='<?php echo e(asset('assets/thumbnail/hok.webp')); ?>'; this.onerror=null;"
                            ...
                            <div class="flex-1 min-w-0">
                                <h4
                                    ...
                                    <?php echo e($category->nama); ?></h4>
                                <p class="text-slate-400 text-[10px] mt-0.5 line-clamp-1"><?php echo e($category->sub_nama); ?></p>
                            </div>
                        </a>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="populer-scroll-desktop" class="relative z-10">
                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($category->tipe == 'populer'): ?>
                        <div class="uiverse-container" onclick="window.location.href='<?php echo e(url('/id/' . $category->kode)); ?>'" style="cursor: pointer;">
                            <div class="uiverse-spacer"></div>
                            <div class="uiverse-canvas absolute inset-0">
                                <?php for($i = 1; $i <= 25; $i++): ?>
                                    <div class="uiverse-tracker uiverse-tr-<?php echo e($i); ?>"></div>
                                <?php endfor; ?>
                                <div class="uiverse-card">
                                    <div class="uiverse-card-content p-2 w-full h-full relative">
                                        ...
                                        <div
                                            ...
                                            <span
                                                class="z-20 leading-5 pt-3 block bottom-0 text-[11px] truncate px-3 shadow-slate-900 border-none"><?php echo e($category->sub_nama); ?></span>
                                        </div>
        ...
        <section
            ...
            <div id="topup-panel"
                ...
                data-items-limit="12">
                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($category->tipe == 'game' || $category->tipe == 'populer'): ?>
                        
                        <a href="<?php echo e(url('/id/' . $category->kode)); ?>"
                            class="md:hidden group relative aspect-[3/4] bg-slate-900 rounded-3xl overflow-hidden interactive-card border border-white/5 hover:border-secondary/50 transition-all duration-500 shadow-xl <?php echo e($key >= 12 ? 'hidden extra-item' : ''); ?>">
                            <img alt="<?php echo e($category->nama); ?>"
                                src="<?php echo e(str_contains($category->thumbnail, 'http') ? $category->thumbnail : (file_exists(public_path($category->thumbnail)) ? asset($category->thumbnail) : asset('assets/thumbnail/hok.webp'))); ?>"
                                onerror="this.src='<?php echo e(asset('assets/thumbnail/hok.webp')); ?>'; this.onerror=null;"
                        ...
                        <a href="<?php echo e(url('/id/' . $category->kode)); ?>"
                            class="hidden md:flex flex-col group bg-slate-800/30 rounded-3xl overflow-hidden interactive-card border border-white/5 hover:border-secondary/40 transition-all <?php echo e($key >= 12 ? 'hidden extra-item' : ''); ?>">
                            ...
                            <div class="p-4 text-center">
                                ...
                                <p class="text-slate-500 text-[10px] uppercase tracking-widest line-clamp-1">
                                    <?php echo e($category->sub_nama); ?></p>
                            </div>
                        </a>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="mlbb-panel"
                ...
                data-items-limit="12">
                <?php $__currentLoopData = $mlbb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    
                    <a href="<?php echo e(url('/id/' . $item->kode)); ?>"
                        class="md:hidden group relative aspect-[3/4] bg-slate-900 rounded-3xl overflow-hidden interactive-card border border-white/5 hover:border-secondary/50 transition-all duration-500 shadow-xl <?php echo e($key >= 12 ? 'hidden extra-item' : ''); ?>">
                        <img alt="<?php echo e($item->nama); ?>"
                            src="<?php echo e(str_contains($item->thumbnail, 'http') ? $item->thumbnail : (file_exists(public_path($item->thumbnail)) ? asset($item->thumbnail) : asset('assets/thumbnail/hok.webp'))); ?>"
                            onerror="this.src='<?php echo e(asset('assets/thumbnail/hok.webp')); ?>'; this.onerror=null;"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                        <div
            ...
            <div class="relative z-10 flex flex-col items-center gap-4 md:gap-10">
                ...
                <div class="grid grid-cols-2 gap-x-2 gap-y-4 md:flex md:flex-wrap items-center justify-center md:gap-16">
                    <div class="flex flex-col md:flex-row items-center gap-4 group/stat text-center md:text-left">
                        ...
                        <div>
                            <p class="text-lg md:text-3xl font-black text-white leading-none mb-1">
                                <?php echo e(number_format($total_users, 0, '.', '.')); ?>+</p>
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-4 group/stat text-center md:text-left">
                        ...
                        <div>
                            <p class="text-lg md:text-3xl font-black text-white leading-none mb-1">
                                <?php echo e(number_format($total_games, 0, '.', '.')); ?>+</p>
                            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest whitespace-nowrap">
                                Games</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-4 group/stat text-center md:text-left">
                        ...
                        <div>
                            <p class="text-lg md:text-3xl font-black text-white leading-none mb-1">
                                <?php echo e(number_format($total_products, 0, '.', '.')); ?>+</p>
                            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest whitespace-nowrap">
                                Product</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-4 group/stat text-center md:text-left">
                        ...
                        <div>
                            <p class="text-lg md:text-3xl font-black text-white leading-none mb-1">
                                <?php echo e(number_format($total_transactions, 0, '.', '.')); ?>+</p>
                            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest whitespace-nowrap">
                                Transaksi</p>
                        </div>
                    </div>
        ...
        <section class="mb-20">
            <?php echo $__env->make('components.user.testimonials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </section>
    </main>

    <?php echo $__env->make('components.user.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\muslihinnnn (1)\harydata\resources\views/index.blade.php ENDPATH**/ ?>